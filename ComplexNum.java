...
class ComplexNum{  
	...
	{  
		...
		System.out.println("Enter 1st Real number:");	//real number input from user end
		int a1Real = num.nextInt();

		System.out.println("Enter 2nd Real number:");	
		int a2Real = num.nextInt();

		System.out.println("Enter 1st Imaginary number:");	//imaginary number input from user end
